...
<head>
  ...
  <style>
    :root{--bg:#0b1020;--panel:#111827;--muted:#a7b0c0;--text:#e5e7eb;--brand:#22d3ee;--brand2:#a78bfa;--border:rgba(167,176,192,.26);}
    @media (prefers-color-scheme: light){:root{--bg:#f8fafc;--panel:#fff;--muted:#475569;--text:#0f172a;--border:rgba(71,85,105,.26);}}
    *,*::before,*::after{box-sizing:border-box} html,body{height:100%}
    ...
    header{position:sticky;top:0;backdrop-filter:saturate(180%) blur(12px);background:rgba(11,16,32,.75);
    ...
    .section{padding:34px 0} .section h2{font-size:clamp(20px,3vw,28px);margin:0 0 14px}
    .grid{display:grid;grid-template-columns:repeat(12,1fr);gap:16px}
    .card{grid-column:span 12;padding:18px;background:rgba(17,24,39,.88);border:1px solid var(--border);
      border-radius:16px;box-shadow:0 10px 30px -20px rgba(0,0,0,.35)}
    @media (prefers-color-scheme: light){.card{background:#fff}}
    @media (min-width:860px){.card.md6{grid-column:span 6}}
    ...
    .kbd{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;background:rgba(17,24,39,.7);
...
<body>
  <header>
    <div class="container nav">
      <div class="brand"><span class="dot"></span> Xinfeng Gu</div>
      <nav class="links">
  ...
  <main class="container">
    <section class="hero" id="home">
      <div>
        ...
        <p class="tagline">I turn unstructured signals (text, on-chain, microstructure) into tradable research with evidence.</p>
        <div class="cta">
      ...
      <div class="card">
        <h3>Now / 最近在做</h3>
        <ul class="muted">
          <li>Finance/Crypto <strong>Text → Signal → Backtest</strong></li>
          <li>Uniswap v3 LP <strong>band</strong> rebalancing</li>
    ...
    <section class="section" id="projects">
      ...
      <div class="grid">
        ...
        <article class="card md6">
          <h3>text_signal_mvp</h3>
          <p class="muted">Text → Signal → IC → Backtest</p>
    ...
    <section class="section" id="about">
      <h2>About</h2>
      <div class="card">
        <p>Hi! I’m <strong>Xinfeng</strong>. I work at the intersection of Quant, Crypto-Quant, Zero-Knowledge, and LLMs.</p>
      </div>
    </section>
  ...
  <footer class="container footer">
    ...
    <div class="links"><a href="#home">Back to top ↑</a></div>
  </footer>
